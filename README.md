...
You need to provide two INPUT files (orig_summary_filename queries_for_summary) and one filename for OUTPUT  and finally  the address_of_endpoint {OPTIONAL} 
<br><b> <br>
