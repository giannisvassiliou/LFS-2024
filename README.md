...
You need to provide two INPUT files (<b> orig_summary_filename</b> and <b> queries_for_summary</b> ) and one filename for OUTPUT(the actual .nt LFS Summary) ,  finally  the address_of_endpoint <b>{OPTIONAL} </b>
<br><b> <br>
